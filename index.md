...
| ある程度時間がある | **約10分** | 上記 + [2. システムアーキテクチャ](#2-システムアーキテクチャ全体像) / [Verification](./verification.html) の要点 |
| 詳細までじっくり見たい | **約30分** | 上記 + [4. 設計補足](#4-設計補足通信制御に関する考慮点) / [5. 苦労した点](#5-苦労した点と解決アプローチ) / [Automation](./automation.html) / [10分詳細版PPTX](./Mulutiproxy_System_AWS_10min_ver3.pptx) |
| 設計判断まで深掘りしたい | **追加 約20分** | [AWS 移行設計案](./aws-deployment-plan.html)（実装未実施） |
| 口頭説明用 | — | [ポートフォリオ説明用スクリプト](./interview-pitch.html)（5分概要版・10分詳細版に対応） |
